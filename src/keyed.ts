...
export const parent =
  <T>(tag: string, attrs: Array<Attribute<T>>, children: Array<[ NodeKey, RootNode<T> ]>): VKeyedNode<T> =>
    vKeyedNode(tag, attrs, children);
...
export const ol =
  <T>(attrs: Array<Attribute<T>>, children: Array<[ NodeKey, RootNode<T> ]>): VKeyedNode<T> =>
    vKeyedNode('ol', attrs, children);


export const ul =
  <T>(attrs: Array<Attribute<T>>, children: Array<[ NodeKey, RootNode<T> ]>): VKeyedNode<T> =>
    vKeyedNode('ul', attrs, children);
